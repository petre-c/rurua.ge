...
[["index.html", "tarifi/", "საბანკო რეკვიზიტები", "შეფასება Google-ზე"],
  ...
  */
  ...
  /*
    საზღაურის გვერდზე ბმული მთავარი გვერდიდან სრულად მოიხსნა: ჯერ ჰეროდან, მერე
    ჰედერიდან, ბოლოს ფუტერიდან. ანუ კალკულატორზე მხოლოდ პირდაპირი მისამართით ან
    ძებნიდან მიდიან. მთელ გვერდზე ვამოწმებთ და არა მხოლოდ ჰედერში: ფუტერის ბმულს
    სწორედ ის დააკლდა, რომ შემოწმება ერთი უბანზე იყო მიბმული.
  */
  check(`${page}: გვერდზე საზღაურის ბმული აღარ არის`, html.includes(`href="${href}"`), false);
